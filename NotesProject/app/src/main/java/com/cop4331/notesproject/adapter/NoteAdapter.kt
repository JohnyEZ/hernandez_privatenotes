package com.cop4331.notesproject.adapter
...
import com.cop4331.notesproject.*
...
//        val deleteView: ImageView = cardView.delete
        ...
        val label: TextView = cardView.label
    }
            ...
            val dialogClickListener = DialogInterface.OnClickListener { _, which ->
                when (which) {
                    DialogInterface.BUTTON_POSITIVE -> {
                        ...
                        db.delete(itemView.title.text.toString(), itemView.desc.text.toString(), itemView.label.text.toString())
                        ...
                        while (cursor.moveToNext()) {
                            ...
                            cardlist.add(note(cursor.getString(1), cursor.getString(2), cursor.getString(3)))
                        }
...
//                    DialogInterface.BUTTON_NEUTRAL -> Toast("Neutral/Cancel button clicked.")
        ...
        itemView.edit.setOnClickListener {
            ...
            intent.putExtra("Label", itemView.label.text.toString())
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.label.text = currentItem.noteTag
    }
